...
<head>
    ...
    <?php } elseif($value['id'] == 2) { ?>
        <link rel="stylesheet" href="styles-ball-bv.css">
...
<body>
            ...
            <div class="container-fluid">
                ...
                <?php 
                    case 2: {?>
                        <div class="card">
                            <div class="card-body">
                                <div class="p-2 row" id="form">

                                </div>
                            </div>
                        </div>

                        <!-- <div id="new-bet-ball-bv" style="width: 591px; position: relative"> -->
                        <div id="new-bet-ball-bv" style="position: relative">
                            <img id="photo_show" src="photo-ball-bv/mau1_1don.png"/>
                            <img id="photo_demo" src="photo-ball-bv/mau1_demo.png"/>
                        </div>
                                ...
                                <div class="container_box" bis_skin_checked="1">
                                    ...
                                    <div class="box">
                                        <div class="create-image-container" id="new_bill<?php echo $id ?>">
                                            ...
                                            <div id="output_battery_level" class="background_black battery-level<?php if ($id == 3) echo "-3";?>"></div>
    ...
    <?php } elseif($value['id'] == 2) { ?>
        <script src="bet-ball-bv.js"></script>
    <?php } elseif($value['id'] == 3) { ?>
