...
option1_status.value = 1
const option2_status = document.createElement('option')
option2_status.textContent = 'Chờ Duyệt'
option2_status.value = 2
select_status.append(option1_status, option2_status)
...
option1_status_d2.value = 1
const option2_status_d2 = document.createElement('option')
option2_status_d2.textContent = 'Chờ Duyệt'
option2_status_d2.value = 2
select_status_d2.append(option1_status_d2, option2_status_d2)
...
option1_status_d3.value = 1
const option2_status_d3 = document.createElement('option')
option2_status_d3.textContent = 'Chờ Duyệt'
option2_status_d3.value = 2
select_status_d3.append(option1_status_d3, option2_status_d3)
...
select_orders.addEventListener('change', function () {
    ...
    if (select_orders.value == 1) {
        right_mid.innerHTML = ''
        left_bot.innerHTML = ''
        photo_show.src = 'photo-withdrawal/mg_1don.png'
    } else if (select_orders.value == 2) {
        left_bot.innerHTML = ''
        right_mid.append(h4_don2, div_detail_time_d2, div_status_d2, div_price_d2)
        photo_show.src = 'photo-withdrawal/mg_2don.png'
    } else if (select_orders.value == 3) {
        right_mid.append(h4_don2, div_detail_time_d2, div_status_d2, div_price_d2)
        left_bot.append(h4_don3, div_detail_time_d3, div_status_d3, div_price_d3)
        photo_show.src = 'photo-withdrawal/mg_3don.png'
    }
})
...
function import_data1(div_import) {
    ...
    photo_don1.src = 'photo-withdrawal/mg_1don.png'
    ...
    battery.style.width = (49 * input_battery.value / 100) + 'px'
    ...
    text_battery.innerText = `${input_battery.value}`
    ...
    trade_code.textContent = 'G169' + getRandomInt(10000000000, 99999999999) + '6000' + getRandomInt(100000, 999999)  
    ...
    const ten_chuoi = document.createElement('div')
    ten_chuoi.classList.add('ten_chuoi')
    ten_chuoi.textContent = '-'
    
    const tien_te = document.createElement('div')
    tien_te.classList.add('tien_te')
    tien_te.textContent = 'VNDK'

    const dia_chi_gui = document.createElement('div')
    dia_chi_gui.classList.add('dia_chi_gui')
    dia_chi_gui.textContent = '-'
    
    const dia_chi_nhan = document.createElement('div')
    dia_chi_nhan.classList.add('dia_chi_nhan')
    dia_chi_nhan.textContent = '-'

    const ly_do = document.createElement('div')
    ly_do.classList.add('ly_do')
    
    if(select_status.value == 1) {
        status_import.textContent = 'Thành Công'
        ly_do.textContent = 'thành công'
    }
    else if(select_status.value == 2) {
        status_import.textContent = 'Chờ Duyệt'
        ly_do.textContent = '-'
    }

    div_import.append(ten_chuoi, tien_te, dia_chi_gui, dia_chi_nhan, ly_do)
}

function import_data2(div_import) {
    div_import.innerHTML = ''
    const photo_don1 = document.createElement('img')
    photo_don1.src = 'photo-withdrawal/mg_2don.png'
    photo_don1.setAttribute('id', 'photo_show')
    photo_don1.style.width = '800px'
    const photo_demo = document.createElement('img')
    photo_demo.src = 'photo-withdrawal/demo_mg_1.jpg'
    ...
    div_import.append(clock, battery, wifi, custom_icon, text_battery)
    // End Phụ trợ của điện thoại
    ...
    const random_Int1 = getRandomInt(10000000000, 99999999999)
    const random_Int2 = getRandomInt(100000, 999999)
    const trade_code = document.createElement('div')
    const number_trade_code = 'G169' + random_Int1 + '6000' + random_Int2
    trade_code.classList.add('trade_code_v2')
    ...
    trade_code_d2.textContent = 'G169' + (random_Int1 - getRandomInt(100000000, 999999999)) + '6000' + random_Int2
    ...
    const ten_chuoi_d2 = document.createElement('div')
    ten_chuoi_d2.classList.add('ten_chuoi_d2')
    ten_chuoi_d2.textContent = '-'
    
    const tien_te_d2 = document.createElement('div')
    tien_te_d2.classList.add('tien_te_d2')
    tien_te_d2.textContent = 'VNDK'

    const dia_chi_gui_d2 = document.createElement('div')
    dia_chi_gui_d2.classList.add('dia_chi_gui_d2')
    dia_chi_gui_d2.textContent = '-'
    
    const dia_chi_nhan_d2 = document.createElement('div')
    dia_chi_nhan_d2.classList.add('dia_chi_nhan_d2')
    dia_chi_nhan_d2.textContent = '-'

    const ly_do_d2 = document.createElement('div')
    ly_do_d2.classList.add('ly_do_d2')
    
    if(select_status_d2.value == 1) {
        status_import_d2.textContent = 'Thành Công'
        ly_do_d2.textContent = 'thành công'
    }
    else if(select_status_d2.value == 2) {
        status_import_d2.textContent = 'Chờ Duyệt'
        ly_do_d2.textContent = '-'
    }
    
    div_import.append(ten_chuoi_d2, tien_te_d2, dia_chi_gui_d2, dia_chi_nhan_d2, ly_do_d2)
}

function import_data3(div_import) {
    div_import.innerHTML = ''
    const photo_don1 = document.createElement('img')
    photo_don1.src = 'photo-withdrawal/mg_3don.png'
    photo_don1.setAttribute('id', 'photo_show')
    photo_don1.style.width = '800px'
    const photo_demo = document.createElement('img')
    photo_demo.src = 'photo-withdrawal/demo_mg_1.jpg'
    ...
    const trade_code_d2 = document.createElement('div')
    trade_code_d2.classList.add('trade_code_v2_d2')
    const int_trade_code_d2 = random_Int1 - getRandomInt(100000000, 999999999)
    trade_code_d2.textContent = 'G169' + int_trade_code_d2 + '6000' + random_Int2
    ...
    trade_code_d3.textContent = 'G169' + (int_trade_code_d2 - getRandomInt(100000000, 999999999)) + '6000' + random_Int2
    
    div_import.append(detail_time_d3, withdrawal_d3, trade_code_d3)
    
    const ten_chuoi_d3 = document.createElement('div')
    ten_chuoi_d3.classList.add('ten_chuoi_d3')
    ten_chuoi_d3.textContent = '-'
    
    const tien_te_d3 = document.createElement('div')
    tien_te_d3.classList.add('tien_te_d3')
    tien_te_d3.textContent = 'VNDK'

    const dia_chi_gui_d3 = document.createElement('div')
    dia_chi_gui_d3.classList.add('dia_chi_gui_d3')
    dia_chi_gui_d3.textContent = '-'
    
    div_import.append(ten_chuoi_d3, tien_te_d3, dia_chi_gui_d3)
