                        ...
                        <div class="container_box" bis_skin_checked="1">
                                ...
                                <div class="create-image-container" id="new_bill<?php echo $id ?>">
                                    ...
                                    switch ($id) {
                                        ...
                                        case 5: { ?>
                                            ...
                                            <div class="total_price-momo"><span>-<span
                            ...
                            <div class="col-md-6 col-lg-6 col-xl-3">
                                <div class="card" style="margin-top:10px">
                                    <div class="card-body p-4" style="margin:0; width:600px; padding:0 !important">
                                        <div class="p-2 mt-4">
                                            <div>
                                                <label class="form-label">Đồng hồ <span class="data_auto">(*)</span></label>
                                                <input type="text" class="form-control" id="input_clock" placeholder="20:40" style="width: 30%; display: inline-block" value="<?php echo date('H:i') ?>">
                                            </div>
                                            <div>
                                        ...
                                        <?php if ($id == 1) { ?>
                                            <div>
                                                ...
                                                <input type="" class="form-control" id="input_total_price"
                                        ...
                                        <?php if ($id == 8) { ?>
                                            ...
                                            <div>
                                                ...
                                                <input type="text" class="form-control" id="input_recipient_number-techcombank"
                                        ...
                                        <?php if ($id == 10) { ?>
                                            ...
                                            <div>
                                                <label class="form-label">Thời gian giao dịch <span class="data_auto">(*)</span></label>
                                                <input type="text" class="form-control" id="input_trade_time-vietcombank" placeholder="12:29 08/12/2023" value='<?php $days = array(1 => 'Thứ Hai', 'Thứ Ba', 'Thứ Tư', 'Thứ Năm', 'Thứ Sáu', 'Thứ Bảy', 'Chủ Nhật'); $dayOfWeek = $days[date('N')]; echo date('H:i') . " " . $dayOfWeek . " " . date('d/m/Y') ?>'>
                                            </div>
                                            <div>
                                                <label class="form-label">Tên người thụ hưởng</label>
                                            ...
                                            <div>
                                                ...
                                                <select type="text" class="select" id="input_recipient_bank_name-vietcombank">
                                                    ...
                                                    <option value="Ngân hàng Phát triển nhà Tp.HCM (HDBANK)">HD Bank</option>
                                                    ...
                                                    <option value="Ngân hàng Liên Việt (Lien Viet Post Bank)">Lien Viet Post Bank</option>
                                                    <option value="Ngân hàng An Bình (ABBANK)">AB Bank</option>
                                                    <option value="4">Eximbank</option>
                                                    ...
                                                    <option value="Ngân hàng Kiên Long (KienLongBank)">Kien Long Bank</option>
