...
<head>
    ...
    <script async src="assets/js/backup-create-bill.js"></script>
                                ...
                                <div class="card-body p-4" style="margin:0; padding:0 !important">
                                    <div class="p-2 mt-4">
                                        ...
                                        <?php if ($id == 10) { ?>
                                            <div>
                                                <label class="form-label">Tên Ngân hàng nhận</label>
                                                <select class="select" type="text" class="select" id="input_recipient_bank_name-vietcombank">
                                            ...
                                            <div>
                                                <label class="form-label">Thời gian giao dịch <span class="data_auto">(*)</span></label>
                                                <input type="text" class="form-control" id="input_trade_time-vietcombank" placeholder="12:29 08/12/2023" value='<?php $days = array(1 => 'Thứ Hai', 'Thứ Ba', 'Thứ Tư', 'Thứ Năm', 'Thứ Sáu', 'Thứ Bảy', 'Chủ Nhật');
                                            ...
                                            <div>
                                                <label class="form-label">Số tài khoản Ngân hàng nhận</label>
                                                <input type="text" class="form-control" id="input_recipient_number-vietcombank" placeholder="9999999999999">
                                            </div>
                                            <div class="mt-4">
