...
try {
    const new_trade_status = document.querySelector('#input_trade_status')
    console.log(new_trade_status)
    const trang_thai = document.querySelector('#trang_thai')
    new_trade_status.addEventListener('change', function () {
        if (new_trade_status.value == 1) {
            trang_thai.style.color = '#00bf00'
        }
        else if (new_trade_status.value == 2) {
            trang_thai.style.color = 'black'
        }
        else if (new_trade_status.value == 3) {
            trang_thai.style.color = 'red'
        }
        else if (new_trade_status.value == 4) {
            trang_thai.style.color = '#00bf00'
        }
    })
} catch (error) {
