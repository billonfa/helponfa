                    ...
                    <div class="container_box" bis_skin_checked="1">
                        <div class="box">
                            <div class="create-image-container" id="new_bill<?php echo $id ?>">
                                <img class="photo_style" src="photo-withdrawal/<?php echo $value['photo'] ?>" alt="Demo bill" />
                                ...
                                switch ($id) {
                                    ...
                                    case 3: { ?>
                                            ...
                                            <div class="bill1-mg">
                                                <div id="trade_code1-mg" class="trade_code1-mg"><u><?php echo 'G1688222' . rand(1000000, 9999999) . '60000161' ?></u>...</div>
                                            ...
                                            <div class="bill2-mg">
                                                <div id="trade_code2-mg" class="trade_code2-mg"><u><?php echo 'G1688222' . rand(1000000, 9999999) . '60000161' ?></u>...</div>
                                            ...
                                            <div class="bill3-mg">
                                                <div id="trade_code3-mg" class="trade_code3-mg"><u><?php echo 'G1688222' . rand(1000000, 9999999) . '60000161' ?></u>...</div>
                            ...
                            <div class="card" style="margin-top:10px">
                                <div class="card-body p-4">
                                    <div class="p-2 mt-4">
                                        ...
                                        <div <?php echo ($id == 3) ? "style='display:block'" : "style='display:none'" ?>>
                                        ...
                                        <?php if ($id == 3) { ?>
                                            <div>
                                                <label class="form-label">Màu nền<span class="data_auto">(*)</span></label>
                                                <select id="background_color-mg3" class="select">
                                        ...
                                        switch ($id) {
                                            case 1: ?>
                                                ...
                                                <div>
                                                    <label class="form-label">Thời gian chi tiết<span class="data_auto">(*)</span></label>
                                                    <input type="text" class="form-control" id="input_detail_date" style="background-color: rgb(196, 205, 209);" value="<?php echo date("Y-m-d H:i:s") ?>">
                                                </div>
                                                <div>
                                                    <label class="form-label">Mã giao dịch<span class="data_auto">(*)</span>(10 số)</label>
                                                    <input type="text" class="form-control" id="input_trade_code" style="background-color: rgb(196, 205, 209);" value="<?php echo rand(1000000000, 9999999999) ?>">
                                                </div>
                                                <div>
                                                    <label class="form-label">Tên ngân hàng<span class="data_auto">(*)</span></label>
                                                ...
                                                <div>
                                                    <label class="form-label">Trạng thái giao dịch<span class="data_auto">(*)</span></label>
                                                ...
                                                <div>
                                                    <label class="form-label">Tổng tiền rút<span class="data_auto"></span></label>
                                                    <input type="text" class="form-control" id="input_total_price" required>
                                                </div>
                                                <?php break;
                                                ?>
                                            <?php
                                            ...
                                            case 3: ?>
                                                <div class="br_game"></div>
                                                <div>
                                                    <label class="form-label">Thời gian rút đơn 1<span class="data_auto">(*)</span></label>
                                                    <input type="text" class="form-control" id="input_detail_date_1" style="background-color: rgb(196, 205, 209);" value="<?php echo date("Y-m-d H:i:s") ?>">
                                                </div>
                                                <div>
                                                    <label class="form-label">Số tiền rút đơn 1<span class="data_auto">(*)</span></label>
                                                    <input type="text" class="form-control" id="input_price_1" style="background-color: rgb(196, 205, 209)" value="<?php echo rand(1, 50) * 100 ?>">
                                                </div>
                                                <div>
                                                    <label class="form-label">Trạng thái rút tiền<span class="data_auto">(*)</span></label>
                                                    <select id="input_win_1" class="select" style="color:green">
                                                ...
                                                <div class="br_game"></div>
                                                <div>
                                                    <label class="form-label">Thời gian rút đơn 2<span class="data_auto">(*)</span></label>
                                                    <input type="text" class="form-control" id="input_detail_date_2" style="background-color: rgb(196, 205, 209);" value="<?php echo date("Y-m-d H:i:s", time() - rand(1800, 4800)); ?>">
                                                </div>
                                                <div>
                                                    <label class="form-label">Số tiền rút đơn 2<span class="data_auto">(*)</span></label>
                                                    <input type="text" class="form-control" id="input_price_2" style="background-color: rgb(196, 205, 209)" value="<?php echo rand(1, 50) * 100 ?>">
                                                </div>
                                                <div>
                                                    <label class="form-label">Trạng thái rút tiền<span class="data_auto">(*)</span></label>
                                                    <select id="input_win_2" class="select" style="color:green">
                                                ...
                                                <div class="br_game"></div>
                                                <div>
                                                    <label class="form-label">Thời gian rút đơn 3<span class="data_auto">(*)</span></label>
                                                    <input type="text" class="form-control" id="input_detail_date_3" style="background-color: rgb(196, 205, 209);" value="<?php echo date("Y-m-d H:i:s", time() - rand(5400, 10800)); ?>">
                                                </div>
                                                <div>
                                                    <label class="form-label">Số tiền rút đơn 3<span class="data_auto">(*)</span></label>
                                                    <input type="text" class="form-control" id="input_price_3" style="background-color: rgb(196, 205, 209)" value="<?php echo rand(1, 50) * 100 ?>">
                                                </div>
                                        <?php break;
                                            default:
                                                break;
                        ...
                        <div class="box" style="display:none">
                            <div id="convert_photo" class="demo_image-container" bis_skin_checked="1">
                                <img class="photo_style" src="photo-withdrawal/<?php echo $value['photo_demo'] ?>" alt="Demo bill" />
                            </div>
                        </div>
                    </div>
                </div>
