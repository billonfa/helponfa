...
<head>
    ...
    <link rel="stylesheet" href="styles-adroid.css">
</head>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0">Ghép hình vào khung điện thoại</h4>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="container_box" bis_skin_checked="1">
                        <div style="width: 100%;">
                            ...
                            <div id="new-bet-ball" style="width: 800px;">
                                <img id="header_phone" class="header_iphone" src="header/iphone-1.png" src/>
                                <!-- <img class="demo_header" src="photo/adroid_demo.jpg"/> -->
                                <img id="imageDisplay" src="" alt="Hình Ảnh">
                                <img id="footer_phone" class="footer_iphone" src="footer/iphone-1.png"/>
                                <div id="info_phone"></div>
                            </div>
                            <div style="width: 73%; margin-top: 10px;">
                                <button class="btn btn-warning" style="width: 100%;" id="create_bill">Xuất ảnh</button>
                            </div>
                            <div id="convert_photo" bis_skin_checked="1"></div>
                        </div>
                    </div>
                </div>
            </div>
