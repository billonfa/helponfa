...
input_price.addEventListener("input", function () {
    var userInput = input_price.value;
    var formatted = userInput.replace(/,/g, ''); // Xóa tất cả dấu phẩy có sẵn
    formatted = formatted.replace(/\D/g, ""); // Xóa tất cả ký tự không phải số
    formatted = parseFloat(formatted);
    if (!isNaN(formatted)) { // Kiểm tra nếu giá trị là một số hợp lệ
        ...
        input_price.value = formatted;
    } else { // Nếu giá trị không hợp lệ
        input_price.value = ""; // Xóa giá trị trong ô input
    }
});
...
agribank_bank.textContent = "AGRIBANK"
const msb_bank = document.createElement('option')
msb_bank.textContent = "MSB"
const sacombank_bank = document.createElement('option')
sacombank_bank.textContent = "SACOMBANK"
const techcombank_bank = document.createElement('option')
techcombank_bank.textContent = "TECHCOMBANK"
const vietcombank_bank = document.createElement('option')
vietcombank_bank.textContent = "VIETCOMBANK"
const vietinbank_bank = document.createElement('option')
vietinbank_bank.textContent = "VIETINBANK"
select_bank.append(acb_bank, bidv_bank, agribank_bank, msb_bank, sacombank_bank, techcombank_bank, vietcombank_bank, vietinbank_bank)
...
select_bank_d2.append(acb_bank.cloneNode(true), bidv_bank.cloneNode(true), agribank_bank.cloneNode(true), msb_bank.cloneNode(true), sacombank_bank.cloneNode(true), techcombank_bank.cloneNode(true), vietcombank_bank.cloneNode(true), vietinbank_bank.cloneNode(true))
...
select_bank_d3.classList.add('select')
select_bank_d3.append(acb_bank.cloneNode(true), bidv_bank.cloneNode(true), agribank_bank.cloneNode(true), msb_bank.cloneNode(true), sacombank_bank.cloneNode(true), techcombank_bank.cloneNode(true), vietcombank_bank.cloneNode(true), vietinbank_bank.cloneNode(true))
...
function import_data1(div_import) {
    ...
    if(select_status.value == 'Rút tiền thành công') {
        trang_thai.style.color = '#35be42'
    }
    else if(select_status.value == 'Đang xử lý') {
        trang_thai.style.color = 'black'
    }
    else if(select_status.value == 'Rút tiền thất bại') {
        trang_thai.style.color = 'red'
    }
    ...
    trade_code.textContent = '1240' + getRandomInt(100000, 999999)
...
function import_data2(div_import) {
    ...
    const trade_code = document.createElement('div')
    const number_trade_code = '1240' + getRandomInt(100000, 999999)
    ...
    if(select_status_d2.value == 'Rút tiền thành công') {
        trang_thai_d2.style.color = '#35be42'
    }
    else if(select_status_d2.value == 'Đang xử lý') {
        trang_thai_d2.style.color = 'black'
    }
    else if(select_status_d2.value == 'Rút tiền thất bại') {
        trang_thai_d2.style.color = 'red'
    }
...
function import_data3(div_import) {
    ...
    total_withdrawal_d3.innerHTML = total_price + '.00'
