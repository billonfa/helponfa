...
if ($_SESSION['email']) {
    ...
    if ($data['token'] == $_SESSION['token']) {
        if (isset($_GET['id'])) {
            ...
            $sql2 = "SELECT * FROM recharge WHERE id = '$id'";
                    ...
                    <div class="container_box" bis_skin_checked="1">
                        <div style="width: 100%">
                            ...
                            <div id="new-bet-ball" style="width:800px">
                                <?php if($id == 1) {?>
                                <img style="width:800px" id="photo_show" src="photo-recharge/bongvip_1don.png"/>
                                <!-- <img style="width:800px" src="photo-withdrawal/demo-bet-1.png" alt="Demo bill" /> -->
                                <?php } elseif($id == 2) { ?>
                                    <img style="width:800px" id="photo_show" src="photo-recharge/mg_1don.png"/>
